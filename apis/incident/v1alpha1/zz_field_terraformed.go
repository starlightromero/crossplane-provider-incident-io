...
// GetInitParameters of this Field
func (tr *Field) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Field
func (tr *Field) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
