...
// SetObservedGeneration of this Workflow.
func (mg *Workflow) SetObservedGeneration(generation int64) {
	mg.Status.SetObservedGeneration(generation)
}

// GetObservedGeneration of this Workflow.
func (mg *Workflow) GetObservedGeneration() int64 {
	return mg.Status.GetObservedGeneration()
}

// Ensure Workflow implements resource.Managed.
var _ xpresource.Managed = &Workflow{}
